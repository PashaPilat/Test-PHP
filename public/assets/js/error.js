...
function showTab(id) {
  (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])('.tab-panel').hide();
  (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])('#' + id).fadeIn(200);
}
...
function toggleAcc(el) {
  ...
  if (block.classList.contains('open')) {
    (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])(pre).slideUp(200);
    block.classList.remove('open');
  } else {
    (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])(pre).slideDown(200);
